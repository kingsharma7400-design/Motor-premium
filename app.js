...
(function () {
  ...
  function pickODRate(zonedSlabs, age, ccValue) {
    ...
    if (age <= 7) return slab.age7 || slab.rate;
    if (age <= 10) return slab.age7plus || slab.age10 || slab.rate;
  ...
  function runCalc() {
    ...
    const commRates = getCommissionRates(inputs.vehicleType, inputs.policyType, age, inputs.cc, inputs.uwDiscount);
